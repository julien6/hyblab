...
var svg = d3
    .select(document.getElementById('testMap'))
    .append('svg')
    .attr('width', width)
    .attr('height', height);
...
var projection_mam = d3.geoProject(loire, albersProjection);
...
function print_locations_assmat() {
    if (pressAssmat == 0) {
        assmat_location
            ...
            .attr('r', 0.7);
        pressAssmat = 1;
        document.getElementsByClassName('button6x1')[0].style.backgroundColor =
            '#F2ED6F';
...
function print_locations_mam() {
    if (pressMam == 0) {
        mam_location
            ...
            .attr('r', 3);
        pressMam = 1;
        document.getElementsByClassName('button6x2')[0].style.backgroundColor =
            '#587792';
    } else if (pressMam == 1) {
...
function print_locations_creche() {
    if (pressCreche == 0) {
        creche_location
            ...
            .attr('r', 3);
        pressCreche = 1;
        document.getElementsByClassName('button6x3')[0].style.backgroundColor =
            '#BB4430';
